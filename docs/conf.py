...
# -*- coding: utf-8 -*-
#
# action-updater documentation build configuration file, created by
...
from action_updater import version  # noqa
...
htmlhelp_basename = "action-updater-doc"
...
latex_documents = [
    ("index", "action-updater.tex", "action-updater Documentation", "Vanessa Sochat", "manual"),
]
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat"],
        "action-updater",
        "action-updater is a tool for updating GitHub action workflows",
        "Miscellaneous",
    ),
]
